...
<body>
    ...
    <div class="header-text">
        <h3 class="wow animate__flipInY">product view</h3>
        <p><a href="home.php">home</a><span>/View</span></p>
    </div>


    <section class="products">
        <h1 class="headding-2">quick view</h1>
        <div class="box-container">
            <?php
            $id = $_GET['id'];
            $sql = "select * from home_productstable where id='$id'";
            $result = $connection->query($sql);
            ...
            <form action="add_cart.php" class="box wow animate__zoomIn " method="POST">
                ...
                <a href="#categry.php" class="foods" name='sub_title'>
                    <?php echo $row['sub_title'] ?>
                </a>
                <div class="name" name='title'>
                    <?php echo $row['title'] ?>
                </div>
                <div class="flex">
                    <div name='price'>
                ...
                <input type="submit" name="add_to_cart" value="add to card" class="btn-1 btn-box">
            </form>
        ...
        <div class="wow animate__zoomIn  ">
            <h2 class="text-center text-success fw-bold ">product details</h2>
            <br>
            <p class="fs-3 text-dark text-center  m-auto" style="max-width:80rem">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis recusandae ipsa architecto quae molestias, saepe dicta voluptatem ut odio suscipit dolore maxime adipisci iste dolor excepturi quibusdam, distinctio, eos voluptate.</p>
        </div>
    </section>
