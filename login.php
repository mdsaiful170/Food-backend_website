...
<body>
    ...
    <section class="login" style="margin-top:10rem">
        ...
        ?>
        <form action="./update-file/user_login.php" method="POST" class="box wow animate__zoomInDown">
            ...
            <div class="inputbox">
                ...
                <input type="email" name="email" maxlength="50" placeholder="email" required id=""
            ...
            <p>dont have an account?<a href="user_register.php">register now</a></p>
