...
<body>
    ...
    <div class="header-text">
        <h3 class="wow animate__flipInY">contact us</h3>
    ...
    <section class="contact">
        ...
        <div class="box-container">
            ...
            <div class="image" data-aos="zoom-in-down" data-aos-delay="150">
                <?php $sql = 'select*from contact_imagetable';
                $result = $connection->query($sql);
            ...
            <?php $sql = 'select*from contact_msgtable';
            $result = $connection->query($sql);
            $row = mysqli_fetch_array($result);
            ?>


            <form action="./update-file/contact_msgsend.php" class="box" method="POST" data-aos="zoom-in-down"
                data-aos-delay="150">
                ...
                <div class="inputbox">
                    <label for="" class="fas fa-user"></label>
                    <input type="text" name="name" required placeholder="enter your name" id="text">
                </div>

                <div class="inputbox">
                    <label for="" class="fas fa-envelope"></label>
                    <input type="email" name="email" required placeholder="enter your eamil" id="">
                </div>

                <div class="inputbox">
                    <label for="" class="fas fa-phone"></label>
                    <input type="number" name="number" placeholder="enter your number" id="">
                </div>

                <textarea name="sendtext" placeholder="text massage" id="" cols="30" rows="10"
