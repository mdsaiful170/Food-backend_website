...
<body>
    ...
    <div class="header-text">
        <h3 class="wow animate__flipInY">update profile</h3>
    ...
    <section class="register">
        ...
        ?>
        <form action="./update-file/update_profile2.php" method="POST" class="box wow animate__zoomIn">
           
            <h2>upadet profile</h2>


            <input type="text" name="name" class="box-1" placeholder="enter your name" required maxlength="50"
                oninput="if(this.value = this.value.replace(/\s/g, ''))" id="" value="<?php echo $row['name'] ?>">

            <input type="email" name="email" class="box-1" required maxlength="50" placeholder="enter your email"
                oninput="if(this.value = this.value.rolace(/\s/g, ''))" id="" value="<?php echo $row['email'] ?>">
            ...
            <input type="password" name="password" class="box-1" placeholder="enter your password" maxlength="12" id=""
                oninput="if(this.value = this.value.replace(/\s/g, ''))" value="<?php echo $row['password'] ?>">
            ...
            <input type="password" name="con_password" class="box-1" placeholder="conforam your password" maxlength="12"
                ...
                value="<?php echo $row['con_password'] ?>">

            <input type="submit" value="update now" class="sub-btn">
        </form>
    </section>
