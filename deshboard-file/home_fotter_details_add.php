                            ...
                            <div class="card bg-dark" style="height:100%">
                                ...
                                <ul class="text-white">
                                    <li class="mt-2"><a class="text-light text-decoration-none  "
                                            href="#">home fotter details add </a></li>
                                </ul>
                            ...
                            <div class="row w-100">
                                <div class="card-body">
                                    <div class="card p-1 px-2" style="background:#ff9966;">
                                        ...
                                        <form action="home_fotter_details_add2.php" method="POST" enctype="multipart/form-data">
                                            <div class="p-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="sub_title_2" required>
                                                </div>
