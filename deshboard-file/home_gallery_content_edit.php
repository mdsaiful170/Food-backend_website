                    ...
                    <div class="row px-2">
                        <div class="col-xl-3 card-body">
                            <div class="card bg-dark" style="min-height:100%">
                                ...
                                <ul class="text-white">
                                    <li class="mt-2"><a class="text-light text-decoration-none  " href="#">home gallery
                                            content </a></li>
                                </ul>
                            ...
                            <div class="row w-100">
                                <div class="card-body">
                                    <div class="card p-1 px-2" style="background:#ff9966;">
                                        ...
                                        <?php
                                        $id = $_GET['id'];
                                        $sql = "select * from gallery_table where id='$id'";
                                        $result = $connection->query($sql);
                                        $row = mysqli_fetch_array($result);
                                        ?>


                                        <form action="home_gallery_content_edit2.php" method="POST"
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="mb-3">
                                                    <label class="fs-6 fw-bold mb-1 text-dark">contnet</label>
                                                    <textarea class="form-control" name="subtitle"><?php echo $row['subtitle']; ?>
                                                    </textarea>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    <label class="fs-6 fw-bold mb-1 text-dark">Title</label>
                                                    <input type="text" class="form-control"
                                                        value="<?php echo $row['link']; ?>" name="link" required>
                                                </div>
