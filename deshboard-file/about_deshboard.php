            ...
            <div class="col-xl-12  card-body">
                ...
                <div class="card card-box border-1 shadow-2">
                    <div class="row d-flex align-itmes-center justify-content-center text-center py-2 pt-3">
                        ...
                        <h5 class="text-danger fw-bold col-xl-3 col-md-2  ">About Deshboard</h5>
                    ...
                    <div class="row px-2">
                                ...
                                <ul class="nav nav-pills mb-3 list-group" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        ...
                                        <button class="nav-link active btn-4" id="pills-home-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-about_banner" type="button" role="tab"
                                            aria-controls="pills-home" aria-selected="true"><i
                                                class="fas fa-arrow-right text-white arrow"></i> about banner 
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link btn-4" id="pills-profile-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-about_steps" type="button" role="tab"
                                            aria-controls="pills-profile" aria-selected="false"><i
                                                class="fas fa-arrow-right text-white arrow"></i> about simple steps
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link btn-4" id="pills-profile-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-about_review" type="button" role="tab"
                                            aria-controls="pills-profile" aria-selected="false"><i
                                                class="fas fa-arrow-right text-white arrow"></i> about review 
                                        </button>
                                    </li>
                                </ul>
                        ...
                        <div class="tab-content col-xl-9" id="pills-tabContent">
                            ...
                            <!-- =====================about banner div=========== -->
                            <div class="tab-pane fade show active" id="pills-about_banner" role="tabpanel"
                                aria-labelledby="pills-home-tab" tabindex="0">
                                <div class="card-body">
                                    <div class="card bg-dark p-1 px-2">
                                        <div class="card-header border-bottom-1 border-light">
                                            <h5 class="text-center text-white">about banner table</h5>
                                        </div>
                                        <br>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = $result->fetch_assoc()) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class=" border-1 border-white bg-dark text-white ">
                                                            <a href="about_banner_edit.php?id=<?php echo $row['id']; ?>"
                            ...
                            <!-- =========about steps  div========  -->
                            <div class="tab-pane fade" id="pills-about_steps" role="tabpanel"
                                aria-labelledby="pills-profile-tab" tabindex="0">
                                <div class="card-body">
                                    <div class="card bg-dark p-1 px-2">
                                        <div class="card-header border-bottom-1 border-light">
                                            <h5 class="text-center text-white">about steps table</h5>
                                        </div>
                                        <br>
                                        <div>
                                            <a href="./about_steps_add.php" class="btn-3 text-decoration-none">add
                                                now
                                            </a>
                                        </div>
                                        <br>
                                        <table class="table  bg-dark">
                                            ...
                                            <tbody>
                                                <?php
                                                $serial = 1;
                                                $sql = 'select*from about_stepstable';
                                                $result = $connection->query($sql);
                                                while ($row = $result->fetch_assoc()) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class=" border-1 border-white bg-dark text-white ">
                                                            <a href="about_steps_edit.php?id=<?php echo $row['id']; ?>"
                                                                class="btn-3  text-decoration-none d-block">edit</a>
                                                                <br>

                                                            <a href="about_steps_delete.php?id=<?php echo $row['id']; ?>"
                            ...
                            <!-- =========about review div========  -->
                            <div class="tab-pane fade" id="pills-about_review" role="tabpanel"
                                aria-labelledby="pills-profile-tab" tabindex="0">
                                <div class="card-body">
                                    <div class="card bg-dark p-1 px-2">
                                        <div class="card-header border-bottom-1 border-light">
                                            <h5 class="text-center text-white">about review table</h5>
                                        </div>
                                        <br>
                                        <div>
                                            <a href="./about_review_add.php" class="btn-3 text-decoration-none">add
                                                now
                                            </a>
                                        </div>
                                        <br>
                                        <table class="table  bg-dark">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th class="border-1 border-white bg-dark text-white" scope="col">id</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $serial = 1;
                                                $sql = 'select*from about_reviewstable';
                                                $result = $connection->query($sql);
                                                while ($row = $result->fetch_assoc()) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class=" border-1 border-white bg-dark text-white ">
                                                            <a href="about_review_edit.php?id=<?php echo $row['id']; ?>"
                                                                class="btn-3  text-decoration-none d-block">edit</a>
                                                                <br>

                                                            <a href="about_review_delete.php?id=<?php echo $row['id']; ?>"
                                                                class="btn-3 text-decoration-none d-block">delete</a>
