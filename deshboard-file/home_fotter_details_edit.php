                            ...
                            <div class="card bg-dark" style="min-height:100%">
                                ...
                                <ul class="text-white">
                                    <li class="mt-2"><a class="text-light text-decoration-none  "
                                            href="#">home fotter details edit</a></li>
                                </ul>
                            ...
                            <div class="row w-100">
                                <div class="card-body">
                                    <div class="card p-1 px-2" style="background:#ff9966;">
                                        ...
                                        <?php
                                        $id = $_GET['id'];
                                        $sql = "select * from footter_detalistable where id='$id'";
                                        ...
                                        <form action="home_fotter_details_edit2.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="mb-3">
                                                    <label class="fs-6 fw-bold mb-1 text-dark">sub_title_2</label>
                                                    <input type="text" class="form-control" name="sub_title_2"
                                                        value="<?php echo $row['sub_title_2'] ?>" required>
                                                </div>
