                    ...
                    <div class="row px-2">
                        <div class="col-xl-3 card-body">
                            <div class="card bg-dark" style="min-height:100%">
                                ...
                                <ul class="text-white">
                                    <li class="mt-2"><a class="text-light text-decoration-none  " href="#">menu cake items
                                            edit</a></li>
                                </ul>
                            ...
                            <div class="row w-100">
                                <div class="card-body">
                                    <div class="card p-1 px-2" style="background:#ff9966;">
                                        ...
                                        <?php
                                        $id = $_GET['id'];
                                        $sql = "select * from menu_caketable where id='$id'";
                                        ...
                                        <form action="menu_cake_edit2.php" method="POST"
