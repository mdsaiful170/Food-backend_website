            ...
            <div class="col-xl-12  card-body">
                ...
                <div class="card card-box border-1 shadow-2">
                    <div class="row d-flex align-itmes-center justify-content-center text-center py-2 pt-3">
                        <div class="col-xl-2 col-md-2 "><a class="btn-2" href="./about_deshboard.php"><i
                    ...
                    <div class="row px-2">
                        <div class="col-xl-3 card-body">
                            <div class="card bg-dark" style="min-height:100%">
                                ...
                                <ul class="text-white">
                                    <li class="mt-2"><a class="text-light text-decoration-none  " href="#">about review
                                            edit </a></li>
                                </ul>
                            ...
                            <div class="row w-100">
                                <div class="card-body">
                                    <div class="card p-1 px-2" style="background:#ff9966;">
                                        ...
                                        <?php
                                        $id = $_GET['id'];
                                        $sql = "select * from about_reviewstable where id='$id'";
                                        ...
                                        <form action="about_review_edit2.php" method="POST"
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="mb-3">
                                                    <label class="fs-6 fw-bold mb-1 text-dark">name</label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea type="text" class="form-control" name="content" required><?php echo $row['content']; ?>
                                                    </textarea>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    <label class="fs-6 fw-bold mb-1 text-dark">name</label>
                                                    <input type="text" class="form-control"
                                                        value="<?php echo $row['icon'];?>" name="icon" required>
                                                </div>
