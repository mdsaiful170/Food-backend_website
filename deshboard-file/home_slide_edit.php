                            ...
                            <div class="row w-100">
                                <div class="card-body">
                                    <div class="card p-1 px-2" style="background:#ff9966;">
                                        ...
                                        <?php
                                        $id = $_GET['id'];
                                        $sql = "select * from home_slidetable where id='$id'";
                                        ...
                                        <form action="home_slide_edit2.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="mb-3">
                                                    <label class="fs-6 fw-bold mb-1 text-dark">Sub Title</label>
                                                ...
                                                <div class="mb-3">
                                                    <label class="fs-6 fw-bold mb-1 text-dark">link</label>
