                            ...
                            <div class="card bg-dark" style="min-height:100%">
                                ...
                                <ul class="text-white">
                                    <li class="mt-2"><a class="text-light text-decoration-none  "
                                            href="#">home fotter cotnact edit</a></li>
                                </ul>
                            ...
                            <div class="row w-100">
                                <div class="card-body">
                                    <div class="card p-1 px-2" style="background:#ff9966;">
                                        ...
                                        <?php
                                        $id = $_GET['id'];
                                        $sql = "select * from footter_table where id='$id'";
                                        ...
                                        <form action="home_fottercontact_edit2.php" method="POST" enctype="multipart/form-data">
