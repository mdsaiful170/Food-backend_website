...
<body>
    ...
    <div class="header-text">
        <h3 class="wow animate__flipInY">about us</h3>
    ...
    <section class="about">
        <div class="box-container">
            ...
            <div class="content" data-aos="fade-left" data-aos-delay="150" >
                ...
                <a href="menu.php" class="btn-1 wow animate__flipInY">our menu</a>
            </div>
        </div>
        <hr>
    </section>
    ...
    <!-- ===========about steps section======= -->
    <section class="steps" data-aos="zoom-in" data-aos-delay="150">

        <h3 class="headding-2 tlt" data-in-effect="tada" data-out-effect="tada"> simple steps</h3>

        <div class="box-container owl-carousel steps-owl" >
    ...
    <section class="reviews"data-aos="zoom-in" data-aos-delay="450">

        <h3 class="titel tlt" data-in-effect="tada" data-out-effect="tada">customer's reivew</h3>

        <div class="swiper review-slider">

            <div class="swiper-wrapper" data-aos="zoom-in" data-aos-delay="150">
