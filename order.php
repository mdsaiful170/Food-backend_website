...
<body>
    ...
    <div class="header-text">
        <h3 class="wow animate__flipInY">your order</h3>
    ...
    <section class="order">
        <h3 class="titel tlt" data-in-effect="tada" data-out-effect="tada">place orders</h3>
        <div class="box-container">

            <?php $sql = 'select*from order_table';
            $result = $connection->query($sql);
            while ($row = $result->fetch_assoc()) { ?>


                <div class="box" data-aos="zoom-in-down" data-aos-delay="150">
                    <p style="font-weight:500"> date no : <span class="text-danger">
                            <?php echo date('l jS \of F Y h:i:s A', strtotime($row['date'])); ?>
                        </span> </p>
                    <p style="font-weight:500"> castomer name : <span class="text-danger">
                            <?php echo $row['name']; ?>
                        </span></p>
                    <p style="font-weight:500"> moblie no : <span class="text-danger">
                            <?php echo $row['number']; ?>
                        </span></p>
                    <p style="font-weight:500"> email : <span class="text-danger">
                            <?php echo $row['email']; ?>
                        </span></p>
                    <p style="font-weight:500"> address : <span class="text-danger">
                            <?php echo $row['address']; ?>
                        </span></p>
                    <p style="font-weight:500"> your order : <span class="text-danger">
                            <?php echo $row['order_items']; ?>
                        </span> </p>
                    <p style="font-weight:500"> total price : <span class="text-danger">
                            <?php echo $row['total_price']; ?>
                        </span> </p>
                    <p style="font-weight:500"> payment methods : <span class="text-danger">
                            <?php echo $row['payment-m']; ?>
                        </span> </p>
                    <p style="font-weight:500"> payment : <span class="text-danger">
    ...
    <section class="footter-2">
        <div class="box-container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-xl-3 box" data-aos="fade-right" data-aos-delay="150" data-aos-duration="1200">
                ...
                <div class="col-sm-12 col-md-6 col-xl-2 box"data-aos="fade-up" data-aos-delay="150"   data-aos-duration="1200">
                    <h3>Resource</h3>
                ...
                <div class="col-sm-12 col-md-6 col-xl-2 box"  data-aos="zoom-in" data-aos-delay="150"   data-aos-duration="1200">
                    <h3>quick links</h3>
                ...
                <div class="col-sm-12 col-md-6 col-xl-2 box" data-aos="fade-down" data-aos-delay="150"   data-aos-duration="1200">
                ...
                <div class="col-sm-12 col-md-6 col-xl-3 box"  data-aos="fade-left" data-aos-delay="150"   data-aos-duration="1200">
