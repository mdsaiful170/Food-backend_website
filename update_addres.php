...
<body>
    ...
    <div class="header-text">
        <h3 class="wow animate__flipInY">update address</h3>
        <p><a href="home.php">home</a><span>/address</span></p>
    </div>
    <!-- =====ending===== -->
    ...
    <section class="register">
        ...
        <form action="./update-file/update_address2.php" method="POST" class="box wow animate__zoomIn">

            <h2>Your address</h2>
            <input type="text" value="<?php echo $row['flat_no'] ?>" name="flat_no" class="box-1"
                placeholder="flat no. and building no." required maxlength="30">

            <input type="text" value="<?php echo $row['area'] ?>" name="area" class="box-1" required maxlength="30"
                placeholder="area name">

            <input type="text" value="<?php echo $row['city_name'] ?>" name="city_name" class="box-1" required
                maxlength="30" placeholder="city name">

            <input type="number" value="<?php echo $row['pin_code'] ?>" name="pin_code" class="box-1"
                placeholder="pin code" maxlength="6" id="" oninput="if(this.value = this.value.replace(/\s/g, ''))">

            <input type="submit" value="save address" class="sub-btn">
